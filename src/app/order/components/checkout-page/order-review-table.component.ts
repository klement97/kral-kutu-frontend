          ...
          <table mat-table [dataSource]="orderUnits"
              ...
              <ng-container matColumnDef="code">
                  ...
                  <td mat-cell *matCellDef="let element">
                      {{element.product.properties.code ? element.product.properties.code : '--'}}
                  </td>
              ...
              <ng-container matColumnDef="width">
                  ...
                  <td mat-cell *matCellDef="let element"> {{element.product.properties.width | number}}cm</td>
              </ng-container>

              <!-- Height Column -->
              <ng-container matColumnDef="height">
                  <th mat-header-cell *matHeaderCellDef>{{t('height')}}</th>
                  <td mat-cell *matCellDef="let element"> {{element.product.properties.height | number}}cm</td>
              </ng-container>

              <!-- Length Column -->
              <ng-container matColumnDef="length">
                  <th mat-header-cell *matHeaderCellDef>{{t('length')}}</th>
                  <td mat-cell *matCellDef="let element"> {{element.product.properties.length | number}}cm</td>
              </ng-container>
